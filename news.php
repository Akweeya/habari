<?php require 'assets/php/header.php'; ?>
	<div id="mainarea" class="container">
		...
		<div id="holdcats" class="container">
			...
			<div id="cats13" class="thumbnail cats">
				<div class="catsimg" style="background-image: url('assets/img/cats/desktop_blueprint-wallpaper-1366x768.jpg');">
			...
			<div id="cats14" class="thumbnail cats">
				<div class="catsimg" style="background-image: url('assets/img/cats/desktop_blueprint-wallpaper-1366x768.jpg');">
			...
			<div id="cats15" class="thumbnail cats">
				<div class="catsimg" style="background-image: url('assets/img/cats/desktop_blueprint-wallpaper-1366x768.jpg');">
			...
			<div id="cats16" class="thumbnail cats">
				<div class="catsimg" style="background-image: url('assets/img/cats/desktop_blueprint-wallpaper-1366x768.jpg');">
			...
			<div id="cats17" class="thumbnail cats">
				<div class="catsimg" style="background-image: url('assets/img/cats/desktop_blueprint-wallpaper-1366x768.jpg');">
			...
			<div id="cats18" class="thumbnail cats">
				<div class="catsimg" style="background-image: url('assets/img/cats/desktop_blueprint-wallpaper-1366x768.jpg');">
			...
			<div id="cats19" class="thumbnail cats">
				<div class="catsimg" style="background-image: url('assets/img/cats/desktop_blueprint-wallpaper-1366x768.jpg');">
